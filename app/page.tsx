...
export default function UserManagement() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to fetch users. Make sure your Spring Boot API is running.",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage users with CRUD operations and search functionality (Spring Boot Backend)
          </CardDescription>
        </CardHeader>
        <CardContent>
